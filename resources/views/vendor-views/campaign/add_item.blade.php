                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                ...
                                <div class="col-sm-2 col-lg-3" id="stock_input">
                                    <div class="form-group mb-0">
                                ...
                                <div class="col-sm-2 col-lg-3" id="maximum_cart_quantity">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                ...
                                <div class="col-sm-2 col-lg-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="tax" id="tax"
                                            ...
                                            <option value="7">{{ translate('messages.7_%') }}</option>
                                            <option value="19">{{ translate('messages.19_%') }}</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="0" max="100000" step="0.01" id="nettoPrice"
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="0" max="100000" step="0.01"
                                            value="0" name="brutto_price" class="form-control" id="bruttoPrice"
                                            placeholder="{{ translate('messages.Ex:') }} 100" required>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6">
...
@push('script_2')
    ...
    <script>
        ...
        $('#campaign_form').on('submit', function(e) {
            ...
            $.post({
                url: '{{ route('vendor.campaign.store-item') }}',
