    ...
    <section class="m-0 py-5">
        <div class="container">
            ...
            <div class="section-header">
                <h2 class="title mb-2">{{ translate('messages.wholesaler') }} <span
            ...
            <form class="js-validate" action="{{ route('restaurant.store') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="card __card mb-3">
                    <div class="card-header">
                        <h5 class="card-title">
                            <svg width="20" x="0" y="0" viewBox="0 0 68 68" style="enable-background:new 0 0 512 512"
                    ...
                    <div class="card-body p-4">
                        ...
                        <ul class="nav nav-tabs mb-4">
                            ...
                            foreach(json_decode($language) as $lang){
                                    ...
                                    $flagUrl = ''; // Initialize flag URL variable
                                    // Assign flag URL based on language code
                                    switch ($lang) {
                                        case 'en':
                                            $flagUrl = url('public/assets/en-flag.png'); // URL for United States flag image
                                            break;
                                        case 'de':
                                            $flagUrl = url('public/assets/de-flag.png'); // URL for Germany flag image
                                            break;
                                        case 'tr':
                                            $flagUrl =  url('public/assets/tr-flag.png'); // URL for Turkey flag image
                                            break;
                                        default:
                                            // You might handle other languages differently here if needed
                                            break;
                                    }
                               ?>
                                <li class="nav-item">
                                    <a class="nav-link lang_link" href="#" id="{{ $lang }}-link">
                                        ...
                                        @if ($flagUrl)
                                            <img src="{{ $flagUrl }}" width="30" height="20" alt="{{ $lang }} flag">
                                        @endif
                                    </a>
                                </li>
                            <?php } ?>
                        ...
                        <div class="row row-margin-top">
                                ...
                                <div class="lang_form row" id="default-form">
                                    ...
                                    <div class="col-md-12 col-lg-6 col-sm-12">
                                        <div class="form-group mb-0">
                                            ...
                                            <textarea type="text" required name="address[]" placeholder="{{ translate('messages.store') }}"
                            ...
                            <div class="row row-margin-top">
                                <div class="col-md-6 col-lg-2 col-sm-12" style="display: none;">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="minimum_delivery_time"
                                                class="form-control __form-control" placeholder="Min: 1"
                                                value="{{ old('minimum_delivery_time') }}" required>
                                            <input type="number" name="maximum_delivery_time"
                                                class="form-control __form-control" placeholder="Max: 20"
                                                value="{{ old('maximum_delivery_time') }}" required>
                                            <select name="delivery_time_type"
                                                class="form-control __form-control text-capitalize" id=""
                                                required readonly>
                                    ...
                                    <label id="minimum_delivery_time-error" class="error" for="minimum_delivery_time"></label>
                                    <label id="maximum_delivery_time-error" class="error" for="maximum_delivery_time"></label>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ translate('messages.store_document') }}</label>
                                        <div class="custom-file">
                                            <input type="file" name="store_documents[]" id="store_documents"
                                                class="form-control __form-control" multiple>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="name"
                                            class="input-label pt-2">{{ translate('messages.upload_cover_photo') }} <span
                                                ...
                                                2:1)</span> <span class="text-danger">*</span></label>
                                        <div class="custom-file">
                            ...
                            <div class="row row-margin-top">
                                <small class="text-success"> {{ translate('messages.zone_need_message') }}</small>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 mb-3" style="display: none">
                                    <div class="form-group">
                                        ...
                                        <small
                                            class="text-danger">{{ translate('messages.module_change_warning') }}</small>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-12 col-sm-12 mb-3">
                                    {{-- <input id="pac-input" class="controls rounded" style="height: 3em;width:fit-content;"
                                        ...
                                        <input id="pac-input" class="controls rounded" style="height: 3em;width:25em;"
                                        title="{{ translate('messages.search_your_location_here') }}" type="text"
                                        placeholder="{{ translate('messages.search_here') }}" />
                                    <div id="map"></div>
                                </div>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        <label class="input-label" for="phone">{{ translate('messages.phone') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="phone" id="phone" class="form-control __form-control"
                    ...
                    <div class="card __card mb-3">
                        ...
                        <div class="card-body p-4">
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4 col-sm-12 col-lg-4">
                                    <div class="form-group">
                                        <label class="input-label" for="exampleInputPassword">{{ translate('messages.password') }} <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="password" name="password" placeholder="{{ translate('messages.password_length_placeholder', ['length' => '6+']) }}" class="form-control __form-control form-control __form-control-user" id="exampleInputPassword"  required value="{{ old('password') }}">
                                                <span class="input-group-text toggle-password" id="eye-toggle-password">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </span>
                                        </div>
                                        <label id="exampleInputPassword-error" class="error" for="exampleInputPassword"></label>
                                    </div>
                                </div>
                        
                                <div class="col-md-4 col-sm-12 col-lg-4">
                                    <div class="form-group">
                                        <label class="input-label" for="signupSrConfirmPassword">{{ translate('messages.confirm_password') }} <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="password" name="confirm-password" class="form-control __form-control form-control __form-control-user" minlength="6" id="exampleRepeatPassword" placeholder="{{ translate('messages.password_length_placeholder', ['length' => '6+']) }}" required value="{{ old('confirm-password') }}">
                                          
                                                <span class="input-group-text toggle-password" id="eye-toggle-confirm-password">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </span>
                                          
                                        </div>
                                        <label id="exampleRepeatPassword-error" class="error" for="exampleRepeatPassword"></label>
                                        {{-- <div class="pass invalid-feedback">{{ translate('messages.password_not_matched') }}</div> --}}
                                    </div>
                                </div>

                                <small class="text-success mt-2"><span>Password :
                                    </span>{{ translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters') }}</small>
...
@push('script_2')
    ...
    <script>
        ...
        let infoWindow = new google.maps.InfoWindow({
            content: "{{ translate('Click the map to get Lat/Lng!') }}",
            position: myLatlng,
        });
            ...
            $.get({
                ...
                success: function(data) {
                    ...
                    google.maps.event.addListener(zonePolygon, 'click', function(mapsMouseEvent) {
                        ...
                        // document.getElementById('latitude').value = coordinates['lat'].valid();;
                        // document.getElementById('longitude').value = coordinates['lng'].valid();;
                        $('#latitude').val(coordinates['lat']).valid();
                        $('#longitude').val(coordinates['lng']).valid();
                        infoWindow.open(map);
                    });
                },
            });
        });
        // Add click event listener outside of the AJAX success function
        google.maps.event.addListener(map, 'click', function(mapsMouseEvent) {
            ...
            var clickedLatLng = mapsMouseEvent.latLng;
            if (!google.maps.geometry.poly.containsLocation(clickedLatLng, zonePolygon)) {
                // Clicked outside the selected zone
                infoWindow.close();
                infoWindow = new google.maps.InfoWindow({
                    position: clickedLatLng,
                    content: "{{ translate('messages.Location_not_found_within_the_selected_zone.') }}",
                });
                infoWindow.open(map);
                
                // Optionally, clear the latitude and longitude inputs
                $('#latitude').val('').valid();
                $('#longitude').val('').valid();
            }
        });
        ...
        <script type="text/javascript">
            var onloadCallback = function() {
                grecaptcha.render('recaptcha_element', {
                    'sitekey': '{{ \App\CentralLogics\Helpers::get_business_settings('recaptcha')['site_key'] }}','hl': "{{ app()->getLocale() }}"
                });
            };
        </script>
            ...
            $("#form-id").validate({
                rules: {
                    ...
                    'phone': {
                        ...
                        minlength: 10,
                        remote: {
                            url: "{{ route('restaurant.checkPhoneUnique') }}", // Use the named route
                            type: "post",
                            data: {
                                email: function() {
                                    return $("#email").val();
                    ...
                    'email': {
                        ...
                        email: true,
                        remote: {
                            url: "{{ route('restaurant.checkEmailUnique') }}", // Use the named route
                            type: "post",
                            data: {
                                email: function() {
                                    return $("#email").val();
                ...
                messages: {
                    ...
                    'l_name': {
                        required: "{{ translate('messages.last_name_is_required') }}"
                    },
                    'phone': {
                        required: "{{ translate('messages.phone_is_required') }}",
                        regex: "{{ translate('messages.invalid_phone_format') }}",
                        minlength: "{{ translate('messages.the_phone_number_must_be_at_least_10_digits.') }}",
                        remote: "{{ translate('messages.phone_number_already_exists') }}",
                    },
                    'email': {
                        required: "{{ translate('messages.email_is_required') }}",
                        email: "{{ translate('messages.invalid_email') }}",
                        remote: "{{ translate('messages.email_already_exists') }}",
                    },
                    'password': {
                        required: "{{ translate('messages.password_is_required') }}",
                        minlength: "{{ translate('messages.the_password_must_be_at_least_6_characters.') }}",
                        pattern: "{{ translate('please_enter_a_valid_password_with_at_least_one_uppercase_letter,_one_digit,_and_one_special_character.') }}"
                    },
                    'confirm-password': {
                        required: "{{ translate('messages.confirm_password_is_required') }}",
                        equalTo: "{{ translate('messages.password_not_matched') }}"
                    },
                    'name[]': {
                        required: "{{ translate('messages.name_is_required.') }}",
                    },
                    'zone_id': {
                        required: "{{ translate('messages.zone_is_required') }}",
                    },
                    'logo': {
                        required: "{{ translate('messages.logo_is_required') }}",
                    },
                    'latitude': {
                        required: "{{ translate('messages.latitude_is_required') }}",
                    },
                    'longitude': {
                        required: "{{ translate('messages.longitude_is_required') }}",
                    },
                    'address[]': {
                        required: "{{ translate('messages.address_is_required') }}",
                    },
                    'minimum_delivery_time': {
                        required: "{{ translate('messages.minimum_delivery_time_required') }}",
                        number: "{{ translate('messages.enter_a_valid_number') }}",
                    },
                    'maximum_delivery_time': {
                        required: "{{ translate('messages.maximum_delivery_time_required') }}",
                        number: "{{ translate('messages.enter_a_valid_number') }}",
                    },
                },
