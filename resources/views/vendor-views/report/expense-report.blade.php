                    ...
                    <table class="table table-borderless middle-align __txt-14px">
                        <thead class="thead-light white--space-false">
                            <tr>
                                ...
                                <th class="text-center" style="text-transform: none !important;">{{translate('Date & Time')}}</th>
                                <th class="text-center" >{{ translate('Expense Type') }}</th>
                                <th class="text-center" style="text-transform: none !important;">{{ translate('Customer Name') }}</th>
                                <th class="border-0 text-right pr-xl-5" style="text-transform: none !important;">
                                    <div class="pr-xl-5">
