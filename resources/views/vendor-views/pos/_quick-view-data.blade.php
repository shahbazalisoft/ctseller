        ...
        <div class="details pl-2">
            <a href="{{ route('vendor.item.view', $product->id) }}"
                ...
                <div class="mb-3 text-dark">
                    @if($toggle_tax == 1)
                    <span class="h3 font-weight-normal text-accent mr-1">
                        {{ \App\CentralLogics\Helpers::get_price_range_brutto($product, true) }}
                    </span>
                    @else
                    <span class="h3 font-weight-normal text-accent mr-1">
                    ...
                    @if ($product->discount > 0 || \App\CentralLogics\Helpers::get_store_discount($product->store))
                        <strike class="initial--18">
                            {{ \App\CentralLogics\Helpers::get_price_range_brutto($product) }}
                        </strike>
                    @endif
                </div>
                @endif
                ...
                @if($toggle_tax == 1)
                <div class="mb-3 text-dark">
                    <strong>{{ translate('messages.tax') }} : </strong>
                    <strong
                        id="set-tax">{{ $product['tax'] }}% {{ translate('messages.incl') }}.</strong>
                </div>
                @else
                <div class="mb-3 text-dark">
                    <strong>{{ translate('messages.tax') }} : </strong>
                    <strong
                        id="set-tax">{{  $product['tax'] }}% {{ translate('messages.excl') }}.</strong>
                </div>
    ...
    <div class="row pt-2">
        <div class="col-12">
            ...
            <form id="add-to-cart-form" class="mb-2">
                ...
                <input type="hidden" name="variation_toggle_tax"
                                        value="{{ $toggle_tax}}">
