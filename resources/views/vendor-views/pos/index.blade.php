                    ...
                    <div class="card h-100">
                        <div class="card-header bg-light border-0">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-1 d-flex align-items-center"><span class="line--limit-1 toggle-text">{{ $toggle_tax == 1 ? translate('gross') : translate('net') }}</span>
                                </span>
                                    <input type="checkbox"  class="toggle-switch-input" value="{{ $toggle_tax == 1 ? 1: '' }}" name="toggle_tax" id="toggle_tax" {{ $toggle_tax == 1 ? 'checked': '' }}>
...
@push('script_2')
  ...
  function updateURL(toggleValue) {
      // Get the current URL
      var currentURL = new URL(window.location.href);
      // Set the toggle parameter value
      currentURL.searchParams.set('toggle', toggleValue);
      // Redirect to the updated URL
      window.location.href = currentURL.toString();
  }

  // Event listener for checkbox change
  $('#toggle_tax').change(function(){
      // Get the toggle value (1 for checked, 0 for unchecked)
      var toggleValue = $(this).is(':checked') ? 1 : 0;
      // Update the URL with the toggle value
      updateURL(toggleValue);
  });
