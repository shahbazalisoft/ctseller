...
<div class="content container-fluid">
    <div class="page-header">
        <div class="d-flex flex-wrap justify-content-between">
            ...
            <div class="my-2">
                <a class="btn btn--primary" style="text-transform: none !important;"  href="{{route('vendor.shop.edit')}}"><i class="tio-edit"></i>{{translate('messages.edit_store_information')}}</a>
            </div>
        </div>
    </div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="resturant--info-address">
                        ...
                        <a href="{{route('vendor.shop.doc-download',[$shop->id,$docVal])}}" class="text-decoration-none">
