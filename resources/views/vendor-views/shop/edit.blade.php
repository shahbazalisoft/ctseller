                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center">
                                ...
                                <span>{{translate('messages.store_document')}}</span>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="resturant--info-address">
                                        ...
                                        <div class="custom-file">
                                        @foreach($shop->store_document_uploaded as $docVal)
                                        <a href="{{route('vendor.shop.doc-delete',[$shop->id,$docVal])}}" class="text-decoration-none">
