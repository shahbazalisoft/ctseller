...
@section('content')
    ...
    <div class="content container-fluid">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end" >
                                <button style="text-transform: none !important;" type="button" onclick="@if(env('APP_MODE')!='demo') form_alert('vendor-settings-form','{{translate('messages.you_want_to_update_user_info')}}') @else call_demo() @endif" class="btn btn--primary">{{translate('messages.save_changes')}}</button>
                            </div>
        ...
        data-original-title="{{ translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters') }}"><img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters') }}"></span></label>
                            ...
                            <div class="d-flex justify-content-end">
                                <button style="text-transform: none !important;" type="button" onclick="@if(env('APP_MODE')!='demo') form_alert('changePasswordForm', '{{translate('messages.want_to_update_password')}}') @else call_demo() @endif" class="btn btn--primary">{{translate('messages.save_changes')}}</button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
