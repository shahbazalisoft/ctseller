                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="tax" id="tax"
                                            ...
                                            <option value="7"  {{ $product['tax'] == '7' ? 'selected' : '' }} >{{ translate('messages.7_%') }}</option>
                                            <option value="19" {{ $product['tax'] == '19' ? 'selected' : '' }}>{{ translate('messages.19_%') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                            ...
                            @endif
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" value="{{ $product->brutto_price }}" min="0"
                                            max="999999999999.99" name="brutto_price" class="form-control" step="0.01"
