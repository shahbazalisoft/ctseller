    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-header">
                ...
                @endphp --}}
                    <h5 class="card-title">Products <span class="badge badge-soft-dark ml-2" id="itemCount">{{count($data)}}</span></h5>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-sm-auto">
                            @if($file['type']=='folder')
                            <a class="btn p-0 btn--folder"  href="{{route('vendor.item.gallery', base64_encode($file['path']))}}">
                            ...
                            @elseif($file['type']=='file')
                                ...
                                <div class="btn-items">
                                    ...
                                    <a title="{{translate('Download')}}" data-toggle="tooltip" data-placement="left" href="{{route('vendor.item.gallery.download', base64_encode($file['path']))}}">
                                        <img src="{{asset('/public/assets/admin/img/download/download.png')}}" alt="">
                                    </a>
                                    <form action="{{route('vendor.item.gallery.destroy',base64_encode($file['path']))}}" method="post" onsubmit="form_submit_warrning(event)">
                                        @csrf
                                        @method('delete')
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('vendor.item.gallery.upload')}}"  method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="path" value = "public/product" hidden>
