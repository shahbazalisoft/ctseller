        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="jumbotron pt-1 mb-0 pb-4 bg-white">
                    ...
                    <p>{{ translate('7. You can upload your product images in product folder from gallery, and copy image`s path.') }}</p>
                    <p>{{ translate('8. You can upload products tags') }}</p>
                    <p>{{ translate('9. You can upload products variations') }}</p>
        ...
        $.post({
            ...
            success: function(data) {
                ...
                if (data.errors) {
                    ...
                    var alldata = 'variation: '+data.variation + '\r\n' + 'choice_options: '+data.choice_options + '\r\n' + 'attributes: '+data.attributes;
                    $('#variation_output').val(alldata);
                }
            }
        });
    });
