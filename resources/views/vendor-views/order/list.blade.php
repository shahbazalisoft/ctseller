    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center py-2">
                    ...
                    <div class="d-flex align-items-center">
                        <h1 class="page-header-title text-capitalize">
                            ...
                            <span style="text-transform: none !important;">
                                ...
                                {{str_replace('_',' ',translate('messages.'.$status))}} {{translate('messages.orders')}}
                ...
                <div class="col-sm-auto min--280">
                    <button type="reset" class="btn btn-block btn-primary btn-sm" id="reset">{{translate('messages.Clear all filters')}}</button>
                </div>
            </div>
        </div>
        {{-- <div class="page-header">
        ...
        <div class="card">
            ...
            <div class="card-header py-2 border-0">
                ...
                <form action="{{route('vendor.order.filter')}}" method="POST">
                    <div class="row g-3">
                        @csrf
                        <div class=" col-sm-3 col-md-4">
                            <input type="date" name="from_date" id="from_date" class="form-control" placeholder="Start Date" value="{{isset($from_date)?$from_date:''}}" required="">
                        </div>
                        <span>{{translate('messages.to')}}</span>
                        <div class="col-sm-3 col-md-4">
                            <input type="date" name="to_date" id="to_date" class="form-control" placeholder="End Date" value="{{isset($to_date)?$to_date:''}}" required="">
                        </div>
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-primary" fdprocessedid="jfh8wb">{{translate('messages.next')}}</button>
                        </div>
                    </div>
                </form> 
                ...
                <div class="table-responsive datatable-custom">
                    <table id="datatable" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                        ...
                        <tr>
                            ...
                            <th class="border-0 text-center" style="text-transform: none !important;">{{translate('messages.order_status')}}</th>
...
@push('script_2')
    <script>
        ...
        $('#reset').on('click', function(){
            location.href = '{{url('/')}}/store-panel/order/filter/reset';
        });
    </script>
@endpush
