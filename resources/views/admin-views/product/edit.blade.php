...
@section('title', request()->product_gellary  == 1 ?  'Add item' : 'Edit item')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header d-flex flex-wrap __gap-15px justify-content-between align-items-center">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ request()->product_gellary  == 1 ?  'Add Item' : 'Item Update' }}
                </span>
            </h1>
                        ...
                        <div class="card-body">
                                <div id="default-form">
                                    ...
                                    <div class="form-group pt-2 mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">Short Description</label>
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlSelect1">Sub Category<span
                                                ...
                                                data-original-title="Category required warning"><img
                                ...
                                <div class="col-sm-6 col-lg-3" id="maximum_cart_quantity">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            ...
                                            data-original-title="If this limit is exceeded">
                                            <i class="tio-info-outined"></i>
                                        </span>
                                        </label>
                                        <input type="number" placeholder="Ex: 10" class="form-control" name="maximum_cart_quantity" min="0" value="{{ $product->maximum_cart_quantity }}" id="cart_quantity">
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-0">
                                <label class="input-label"
                                    for="exampleFormControlSelect1">Addon<span
                                        class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                        data-original-title="store required warning"><img
                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
            ...
            <div class="col-md-12">
                <div class="btn--container justify-content-end">
                    <button type="reset" id="reset_btn"
                        class="btn btn--reset">Back</button>
        ...
        $("#add_new_option_button").click(function(e) {
            ...
            var add_option_view = `
                ...
                count + `)">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div>
                                        <label class="input-label text-capitalize d-flex align-items-center"><span class="line--limit-1">Selcetion Type </span>
                                        </label>
