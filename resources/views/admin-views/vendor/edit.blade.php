        ...
        data-original-title="{{translate('messages.store_lat_lng_warning')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.store_lat_lng_warning')}}"></span></label>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center">
                                <span class="card-header-icon mr-2"><i class="tio-shop-outlined"></i></span>
                                <span>{{translate('messages.owner_document')}}</span>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                        for="exampleFormControlInput1">{{ translate('messages.owner_document') }}</label>
                                        <div class="custom-file">
                                            <input type="file" name="store_documents[]" id="store_documents" class="form-control __form-control" multiple>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8 col-sm-6">
                                    <div class="resturant--info-address">
                                        <label class="input-label"
                                        for="exampleFormControlInput1">{{ translate('messages.store_document_uploaded') }}</label>
                                        <div class="custom-file">
                                        @foreach($store->store_document_uploaded as $key=>$docVal)
                                        <a href="{{route('admin.store.doc-delete',[$store->id,$docVal])}}" class="text-decoration-none">
                                            Document {{++$key}} 
