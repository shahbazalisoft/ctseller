...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i class="tio-filter-list"></i> New joining requests</h1>
                ...
                <div class="col-md-12">
                    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
                        ...
                        <ul class="nav nav-tabs mb-3 border-0 nav--tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('admin.wholesaler.pending-requests') }}"   aria-disabled="true">Pending Wholesaler</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <!-- Search -->
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch_" type="search" id="search" name="search" class="form-control"
                                    placeholder="Ex : Search Wholesaler Name" value="{{isset($search_by) ? $search_by : ''}}"aria-label="Search" required>
                            ...
                            <td>
                                @if(isset($store->vendor->status))
                                    ...
                                    <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$store->id}}">
                                        <input type="checkbox" onclick="status_change_alert('{{route('admin.store.status',[$store->id,$store->status?0:1])}}', 'You want to change this store status', event)" class="toggle-switch-input" id="stocksCheckbox{{$store->id}}" {{$store->status?'checked':''}}>
                            ...
                            <td>
                                <div class="btn--container">
                                    ...
                                    @if (!isset($store->vendor->status))
                                        ...
                                        onclick="request_alert('{{route('admin.wholesaler.application',[$store['id'],0])}}','You want to deny this application')"
