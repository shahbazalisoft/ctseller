                ...
                <div class="card">
                    ...
                    <div class="card-header py-2">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">Deliveryman<span
                    ...
                    <div class="table-responsive datatable-custom fz--14px">
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                ...
                                <th class="text-capitalize w-20p">Name</th>
                                <th class="text-capitalize">Contact</th>
                                {{-- <th class="text-capitalize">{{translate('messages.zone')}}</th> --}}
                                <th class="text-capitalize text-center">Total Orders</th>
                                <th class="text-capitalize">Availability status</th>
                                <th class="text-capitalize text-center w-110px">Action</th>
                            </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($dm->application_status == 'approved')
                                                @if($dm->active)
                                                <div>
                                                    Active Status : <strong class="text-primary text-capitalize">Online</strong>
                                                </div>
                                                @else
                                                <div>
                                                    Active Status : <strong class="text-secondary text-capitalize">Offline</strong>
                                                </div>
                                                @endif
                                            @elseif ($dm->application_status == 'denied')
                                                <div>
                                                    Active Status : <strong class="text-danger text-capitalize">Denied</strong>
                                                </div>
                                            @else
                                                <div>
                                                    Active Status : <strong class="text-info text-capitalize">Not approved</strong>
                                                </div>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn btn-sm btn--primary btn-outline-primary action-btn" href="{{route('admin.delivery-man.edit',[$dm['id']])}}" title="Edit"><i class="tio-edit"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
