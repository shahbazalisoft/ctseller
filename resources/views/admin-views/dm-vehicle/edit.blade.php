...
@section('title', 'Update vehicle category')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="type" class="form-control h--45px"
                                            placeholder="ex_:_bike" required maxlength="191"
                                            value="{{ $vehicle['type'] }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="input-label text-capitalize"
                                            for="title">Starting Coverage Area
                                            (Km)<span class="input-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="Minimum coverage area hint"><img
                                                    src="{{ asset('public/assets/admin/img/info-circle.svg') }}"
                                                    alt="public/img"></span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="input-label text-capitalize"
                                            ...
                                            (Km)<span class="input-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="Maximum coverage area hint"><img
                                                    src="{{ asset('public/assets/admin/img/info-circle.svg') }}"
                                                    alt="public/img"></span></label>
...
@push('script_2')
    <script>
        ...
        $('#vehicle-form').on('submit', function(e) {
            ...
            $.post({
                url: '{{ route('admin.delivery-man.vehicle.update', $vehicle->id) }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(data) {
                    if (data.errors) {
                        ...
                        toastr.success('Vehicle category updated', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function() {
