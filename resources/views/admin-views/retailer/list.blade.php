    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title mr-3">
                ...
                <span>
                    Retailer <span class="badge badge-soft-dark ml-2" id="count">{{ $customers->total() }}</span>
                </span>
            </h1>
        </div>
        <!-- End Page Header -->
        ...
        <div class="card">
                ...
                <div class="col-md-12">
                    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
                        ...
                        <ul class="nav nav-tabs mb-3 border-0 nav--tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('admin.retailer.list') }}"   aria-disabled="true">Retailer list</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.retailer.pending-requests') }}"   aria-disabled="true">Pending retailers</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="card-header border-0  py-2">
                <h5 class="card-title">Retailer list</h5>
                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="{{route('admin.retailer.export', ['type'=>'excel',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('public/assets/admin') }}/svg/components/excel.svg"
                                    alt="Image Description">
                                    Excel
                            </a>
                            <a id="export-csv" class="dropdown-item" href="{{route('admin.retailer.export', ['type'=>'csv',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                            ...
                            @foreach ($customers as $key => $customer)
                                <tr class="">
                                    ...
                                    <td class="table-column-pl-0">
                                        <a href="{{ route('admin.retailer.view', [$customer['id']]) }}" class="text--hover">
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm ml-xl-4" for="stocksCheckbox{{ $customer->id }}">
                                            <input type="checkbox"
                                                onclick="status_change_alert('{{ route('admin.retailer.status', [$customer->id, $customer->status ? 0 : 1]) }}', '{{ $customer->status? 'You want to block this retailer':'You want to unblock this retailer' }}', event)"
                                    ...
                                    <td>
                                        <a class="btn action-btn btn--warning btn-outline-warning"
                                            href="{{ route('admin.retailer.view', [$customer['id']]) }}"
                                            title="View retailer"><i
