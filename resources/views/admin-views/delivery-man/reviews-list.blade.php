    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title text-break">
                ...
                <span>Deliveryman reviews<span class="badge badge-soft-dark ml-2" id="itemCount">{{$reviews->total()}}</span></span>
            </h1>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="search--button-wrapper justify-content-end">
                            ...
                            {{-- @csrf --}}
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch" name="search" type="search" class="form-control" placeholder="Ex : search delivery man" value="{{ request()->get('search') }}" aria-label="Search here">
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th class="border-0">Deliveryman</th>
