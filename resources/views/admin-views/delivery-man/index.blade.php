                    ...
                    <div class="row g-4">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">First name</label>
                                        <input type="text" name="f_name" class="form-control" placeholder="First name" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">Last name</label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">Deliveryman type</label>
                                        <select name="earning" class="form-control">
                                            <option value="1">Freelancer</option>
                                            <option value="0">Salary based</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">Zone</label>
                                        <select name="zone_id" class="form-control" required data-placeholder="Select zone">
                                        <option value="" readonly="true" hidden="true">Select zone</option>
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex flex-column h-100">
                                <label class="text-center">Deliveryman image <small class="text-danger">* ( ratio 1:1 )</small></label>
                        ...
                        <div class="col-lg-4">
                            <div class="row g-3">
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">Identity_type</label>
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">Identity Number</label>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label class="form-label" for="exampleFormControlInput1">Identity image</label>
                                <div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="js-form-message form-group mb-0">
                                <label class="input-label" for="signupSrPassword">Password<span class="form-label-secondary" data-toggle="tooltip" data-placement="right"
        data-original-title="Must contain at least one number and one uppercase and lowercase letter and symbol  and at least 8 or more characters"><img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="Must contain at least one number and one uppercase and lowercase letter and symbol  and at least 8 or more characters"></span></label>

                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control" name="password" id="signupSrPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter and symbol  and at least 8 or more characters"
                                    placeholder=":length characters required"
                        ...
                        <div class="col-md-4 col-12">
                            <div class="js-form-message form-group mb-0">
                                ...
                                <div class="input-group input-group-merge">
                                <input type="password" class="js-toggle-password form-control" name="confirmPassword" id="signupSrConfirmPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter and symbol  and at least 8 or more characters"
                                placeholder="length characters required"
                                aria-label="8+ characters required" required
