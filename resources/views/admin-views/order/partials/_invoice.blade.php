                    ...
                    <table class="table invoice--table text-black mt-3">
                        <thead class="border-0">
                            <tr class="border-0">
                                ...
                                <th class="">{{ translate('messages.qty') }}</th>
                                <th class="">{{ translate('messages.tax') }}</th>
                        ...
                        <tbody>
                            ...
                            @else
                                ...
                                @foreach ($order->details as $detail)
                                                ...
                                                @foreach (json_decode($detail['variation'], true)[0] as $key1 => $variation)
                                                    ...
                                                    @if ($key1 != 'price')
                                                        <div class="font-size-sm text-body">
                                                            ...
                                                            {{-- <span>{{ $key1 }} : </span> --}}
                                                            <span
                                                                class="font-weight-bold">{{ $key1 == 'brutto_price' ? \App\CentralLogics\Helpers::format_currency($variation) : $variation }}</span>
                                                        </div>
                                                    @endif
                                                    @endif
                                                @endforeach
                                    ...
                                    <td class="">
                                        {{ $detail['tax'] }}% {{ translate('messages.incl') }}.
                                    </td>
                                    <td class="w-28p">
