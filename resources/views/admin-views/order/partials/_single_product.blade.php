        ...
        <div class="justify-content-between text-center">
            <div class="product-price text-center">
                <span class="text-accent text-dark font-weight-bold">
                    {{\App\CentralLogics\Helpers::format_currency($product['brutto_price']-\App\CentralLogics\Helpers::product_discount_calculate($product, $product['brutto_price'], $store_data)['discount_amount'])}} ( {{ $product['tax'] }}% {{ translate('messages.incl') }}. )
                </span>
            </div>
        </div>
    </div>
