...
<head>
    ...
    <!-- Title -->
    <title>CTSeller</title>
    <!-- Favicon -->
    <link rel="shortcut icon" href="">
    <link rel="icon" type="image/x-icon" href="{{asset('storage/app/public/business/2024-01-13-65a2117db0547.png')}}">
    <!-- Font -->
                ...
                <div class="modal-body pb-5 pt-0">
                    <div class="max-349 mx-auto mb-20">
                        ...
                        <div class="btn--container justify-content-center">
                            <button type="button" id="toggle-ok-button" class="btn btn--primary min-w-120" data-dismiss="modal" onclick="confirmToggle()">Ok</button>
...
<script>
    ...
    function route_alert(route, message, title="are_you_sure") {
        Swal.fire({
            title: title,
            text: message,
            type: 'warning',
