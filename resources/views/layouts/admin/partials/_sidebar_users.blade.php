    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <!-- Custommer -->
                <?php $requestRetailer = \App\Models\User::where('status',2)->count() ?>
                <li class="navbar-vertical-aside-has-menu {{ (Request::is('admin/users/customer/pending-requests') || Request::is('admin/users/customer/deny-requests')) ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.customer.pending_requests') }}" title="{{ translate('messages.retailers') }}">
                        <i class="tio-calendar-note nav-icon"></i>
                        <span class="text-truncate position-relative overflow-visible" >
                            {{ translate('messages.New Retailer') }}
                           @if($requestRetailer) <span class="btn-status btn-status-danger border-0 size-8px"></span> @endif
                        </span>
                    </a>
                </li>
