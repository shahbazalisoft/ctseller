                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/order') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li class="nav-item {{ Request::is('admin/order/list/all') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.order.list', ['all']) }}" title="all_orders">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/category*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li class="nav-item {{ Request::is('admin/category') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.category.index') }}" title="Category">
                                    <span class="tio-circle nav-indicator-icon"></span>
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="Store section">Store Mnagement</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/wholesaler/list')||Request::is('admin/wholesaler/pending-requests') ||Request::is('admin/wholesaler/deny-requests') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.wholesaler.list') }}" title="Wholesaler list">
                            <span class="tio-layout nav-icon"></span>
                            <span class="text-truncate">Wholesaler list</span>
                        </a>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/retailer/list')||Request::is('admin/retailer/pending-requests') ||Request::is('admin/retailer/deny-requests') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.retailer.list') }}" title="Retailer list">
